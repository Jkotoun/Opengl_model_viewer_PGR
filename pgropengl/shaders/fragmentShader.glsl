...
//
//
//  return (diffuse+ambientStrength + specularStrength * spec)*lightColor*diffuseColor.rgb;
//}
//
//
//out vec4 fColor;
...
vec3 phong(
  ...
  return (diffuse+ambientStrength + specularStrength*specular)*lightColor*diffuseColor.rgb;
}
